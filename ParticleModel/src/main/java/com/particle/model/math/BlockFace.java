...
public enum BlockFace {
    DOWN(0, 1, -1, "down", AxisDirection.NEGATIVE, new Vector3d(0, -1, 0)),
    UP(1, 0, -1, "up", AxisDirection.POSITIVE, new Vector3d(0, 1, 0)),
    NORTH(2, 3, 2, "north", AxisDirection.NEGATIVE, new Vector3d(0, 0, -1)),
    SOUTH(3, 2, 0, "south", AxisDirection.POSITIVE, new Vector3d(0, 0, 1)),
    WEST(4, 5, 1, "west", AxisDirection.NEGATIVE, new Vector3d(-1, 0, 0)),
    EAST(5, 4, 3, "east", AxisDirection.POSITIVE, new Vector3d(1, 0, 0));
    ...
    BlockFace(int index, int opposite, int horizontalIndex, String name, AxisDirection axisDirection, Vector3d unitVector) {
        this.index = index;
    ...
    public static BlockFace fromHorizontalIndex(int index) {
        return HORIZONTALS[MathUtils.abs(index % HORIZONTALS.length)];
    }
    ...
    public static BlockFace fromHorizontalAngle(double angle) {
        return fromHorizontalIndex(MathUtils.floorDouble(angle / 90.0D + 0.5D) & 3);
    }
    ...
    public enum Plane implements Predicate<BlockFace>, Iterable<BlockFace> {
        ...
        public BlockFace random(Random rand) { //todo Default Random?
