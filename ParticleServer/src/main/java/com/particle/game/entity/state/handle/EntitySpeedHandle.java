...
@Singleton
public class EntitySpeedHandle extends BaseEffectHandle {
    ...
    public void onStateEnabled(Entity entity, EntityStateRecorder entityStateRecorder, boolean hasEnabled) {
        ...
        entityMovementModule.setMaxSpeed(0.2f + 0.03f * entityStateRecorder.getLevel());
