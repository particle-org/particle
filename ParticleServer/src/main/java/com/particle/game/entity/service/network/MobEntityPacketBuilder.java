...
@Singleton
public class MobEntityPacketBuilder extends AliveEntityPacketBuilder {
    ...
    public IAddEntityPacketBuilder getAddPacketBuilder(MobEntity entity) {
    ...
    private class AddPacketBuilder implements IAddEntityPacketBuilder {
        ...
        public AddPacketBuilder(MobEntity entity) {
            this.entity = entity;
        ...
        public DataPacket[] buildPacket() {
            ...
            if (playerInventory != null) {
                ...
                dataPackets.add(mobEquipmentPacket);
            }
            ...
            if (armorInventory != null) {
                ...
                dataPackets.add(mobArmorEquipmentPacket);
            }
        ...
        private DataPacket buildAddPacket() {
            ...
            addEntityPacket.setAttribute(new EntityAttribute[]{new EntityAttribute(EntityAttributeType.HEALTH, 0, 20, 20, 20)});
