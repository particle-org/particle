...
public class EntityBigScaleHandle implements EntityStateHandle {

    public static final String KEY = "BigScale";
    ...
    public void onStateEnabled(Entity entity, EntityStateRecorder entityStateRecorder, boolean hasEnabled) {
        if (entityStateRecorder.getEnabledCount() == 1 && !hasEnabled) {
            ...
            if (scale < 4.5) {
                metaDataService.setFloatData(entity, EntityMetadataType.SCALE, scale + 0.4f, false);
