...
@Singleton
public class VirtualBlockInteractiveTemplate implements IEntityTemplateCreator {
    ...
    public Entity getEntity(Vector3f position) {
        MobEntity mobEntity = new MobEntity(EntityType.SLIME.actorType(), EntityType.SLIME.type());
        mobEntity.init();
        ...
        entityMetaDataModule.setDataFlag(MetadataDataFlag.DATA_FLAG_INVISIBLE, true);
        // 移动相关
