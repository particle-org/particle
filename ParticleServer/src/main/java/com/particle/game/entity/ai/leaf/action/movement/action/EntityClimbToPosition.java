...
public class EntityClimbToPosition implements IAction {
    ...
    public EStatus tick(Entity entity) {
        ...
        if (targetPosition != null) {
            ...
            this.movementServiceProxy.setMotion(entity, new Vector3f(0, this.physicalService.getGravity(entity), 0));
