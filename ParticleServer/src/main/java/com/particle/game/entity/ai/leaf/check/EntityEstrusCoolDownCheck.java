...
public class EntityEstrusCoolDownCheck implements ICondition {
    ...
    public EStatus tick(Entity entity) {
        ...
        Long timestamp = this.entityDecisionServiceProxy.getKnowledge(entity, Knowledge.ESTRUS_COOL_DOWN, Long.class);
