...
public class NearSurvivorTargetSeeker implements IAction {
    ...
    public EStatus tick(Entity entity) {
        ...
        Player closestPlayer = this.playerService.getClosestPlayer(entity.getLevel(), GameMode.SURVIVE, this.positionService.getPosition(entity), 32);
