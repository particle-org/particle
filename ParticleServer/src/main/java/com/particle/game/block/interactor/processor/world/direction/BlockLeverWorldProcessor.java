...
@Singleton
public class BlockLeverWorldProcessor extends BasicBlockProcessor {
    ...
    public boolean onBlockPrePlaced(Level level, Player player, Block targetBlock, Vector3 targetPosition, Vector3 clickPosition, Vector3f clickOffsetPosition) {
        BlockLeverFace playerDirection = positionService.getLeverFaceDirection(player, targetPosition, clickPosition);
