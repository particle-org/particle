...
@Singleton
public class BlockButtonWorldProcessor extends BasicBlockProcessor {
    ...
    public boolean onBlockPrePlaced(Level level, Player player, Block targetBlock, Vector3 targetPosition, Vector3 clickPosition, Vector3f clickOffsetPosition) {
        BlockButtonFace playerDirection = positionService.getButtonFaceDirection(targetPosition, clickPosition);
