...
@Singleton
public class BlockCocoaUpdater implements IBlockWorldUpdater {
    ...
    public boolean onBlockUpdated(Level level, Player player, Block targetBlock, Vector3 targetPosition, BlockOperationType blockOperationType) {
        boolean positionIllegal = this.cocoaService.checkPositionIllegal(level, targetPosition, targetBlock);
