...
@Singleton
public class ContainerBlockDoorProcessor implements IBlockInteractedProcessor {

    private static final Logger logger = LoggerFactory.getLogger(ContainerBlockDoorProcessor.class);
