...
public class PumpkinStemTileEntity extends TileEntity {
    ...
    public void onCreated(Vector3 position) {
        ...
        // 生长控制
        PlantGrowUpProgressModule plantGrowupProgressModule = PROGRESS_MODULE_HANDLER.bindModule(this);
        plantGrowupProgressModule.randomFutureUpdateTime();

        // 西瓜藤
        StemModule stemModule = STEM_MODULE_HANDLER.bindModule(this);
        stemModule.setStemType(BlockPrototype.PUMPKIN_STEM);
        stemModule.setFruitType(BlockPrototype.PUMPKIN);
    }
