...
@Singleton
public class BlockLadderProcessor extends BasicBlockProcessor {
    ...
    public boolean onBlockPrePlaced(Level level, Player player, Block targetBlock, Vector3 targetPosition, Vector3 clickPosition, Vector3f clickOffsetPosition) {
        BlockLadderFace playerDirection = positionService.get4FaceDirection(targetPosition, clickPosition, BlockLadderFace.class);
