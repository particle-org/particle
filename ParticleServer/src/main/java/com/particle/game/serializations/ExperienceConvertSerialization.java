...
public class ExperienceConvertSerialization implements IStringSerialization<EntityExperienceModule> {
    @Override
    ...
    public void deserialization(GameObject gameObject, String data, EntityExperienceModule entityExperienceModule) {
        ...
        entityExperienceModule.setEntityExperience(convertData);
    }
}
