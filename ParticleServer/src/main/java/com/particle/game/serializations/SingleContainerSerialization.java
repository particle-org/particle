...
public class SingleContainerSerialization implements IStringSerialization<SingleContainerModule> {
    @Override
    public String serialization(GameObject gameObject, SingleContainerModule singleContainerModule) {
        ...
        Class<? extends Inventory> inventoryType = singleContainerModule.getInventory().getClass();
        if (inventoryType == ChestInventory.class) {
            jsonObject.put("type", "Chest");
        } else if (inventoryType == BrewingInventory.class) {
            jsonObject.put("type", "Brewing");
        } else if (inventoryType == FurnaceInventory.class) {
