...
public class OnlineTimeRecorderSerialization implements IStringSerialization<OnlineTimeRecorderModule> {

    private static final Logger LOGGER = LoggerFactory.getLogger(OnlineTimeRecorderSerialization.class);
