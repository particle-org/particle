...
public class FullChunkDataPacketHandler332 extends AbstractPacketHandler<FullChunkDataPacket> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FullChunkDataPacketHandler332.class);
