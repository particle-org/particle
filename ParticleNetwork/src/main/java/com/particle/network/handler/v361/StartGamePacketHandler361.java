...
import com.particle.network.encoder.BlockListEncoderV361;
...
public class StartGamePacketHandler361 extends AbstractPacketHandler<StartGamePacket> {

    private GameRulesHandler gameRulesHandler = GameRulesHandler.getInstance();

    private BlockListEncoderV361 blockListEncoder = new BlockListEncoderV361(BlockInfoReader.read("block_state_list_V1_12.json"));
