...
public class ResourcePackStackPacketHandler388 extends AbstractPacketHandler<ResourcePackStackPacket> {
    ...
    protected void doEncode(ResourcePackStackPacket dataPacket, int version) {
        ...
        dataPacket.writeString(dataPacket.getBaseGameVersion());
    }
}
