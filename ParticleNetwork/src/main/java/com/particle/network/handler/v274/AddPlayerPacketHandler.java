...
public class AddPlayerPacketHandler extends AbstractPacketHandler<AddPlayerPacket> {
    ...
    protected void doDecode(AddPlayerPacket dataPacket, int version) {
        ...
        dataPacket.setPlatformId(dataPacket.readSignedVarInt());
    ...
    protected void doEncode(AddPlayerPacket dataPacket, int version) {
        ...
        dataPacket.writeSignedVarInt(dataPacket.getPlatformId());
