...
public class StartGamePacketHandler332 extends AbstractPacketHandler<StartGamePacket> {

    private GameRulesHandler gameRulesHandler = GameRulesHandler.getInstance();

    private BlockListEncoder blockListEncoder = new BlockListEncoder(BlockInfoReader.read("block_state_list_1_9.json"));
